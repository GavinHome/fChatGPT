import 'package:fchatgpt/app/common/eventbus.dart';
...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  bool extendNavigationRail = false;
  bool showAppBar = true;

  int screenIndex = ScreenSelected.chat.value; //ScreenSelected.component.value;
  ...
  PreferredSizeWidget createAppBar() {
    return AppBar(
      title:
          widget.useMaterial3 ? const Text('fChatGPT') : const Text('fChatGPT'),
      actions: showAppBar && !showMediumSizeLayout && !showLargeSizeLayout
          ? [
              _BrightnessButton(
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return NavigationTransition(
          ...
          navigationRail: showNavigationRail ? NavigationRail(
            extended: showLargeSizeLayout && extendNavigationRail,
            ...
            trailing: Expanded(
              child: Padding(
                ...
                child: showLargeSizeLayout && extendNavigationRail
          ...
          navigationBar: showBottomNavigationBar
              ? NavigationBars(
                  onSelectItem: (index) {
                    setState(() {
                      screenIndex = index;
